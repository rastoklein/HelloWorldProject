...
public class StringExamples {
    public static void main(String[] args) {
        ...
        System.out.println(firstName2.concat(lastName2));   //concat - medzera medzi textom

        String txt3 = "We are the so-called \"Vikings\" from the north.";      //specialne znaky pomocou lomitka
